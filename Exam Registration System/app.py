...
from models import User, Registration, EXAM_TYPES, TIME_SLOTS, MAX_CAPACITY, MAX_UNIQUE_EXAMS
from werkzeug.security import check_password_hash
import re


def register_routes(app: Flask):
    """Register all routes on the provided Flask app instance."""
    ...
    def login():
        ...
        if request.method == 'POST':
            ...
            # if stored passwords are hashed use check_password_hash
    ...
    def register_exam():
        ...
        if existing:
            flash(f'You are already registered for {exam_type} at {time_slot}.', 'error')
            return redirect(url_for('register_exam'))
